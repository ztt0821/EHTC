...
filePath = 'D:\\dataset\\f_track\\gt_107'
file_name = os.listdir(filePath)
save_path = 'D:\\program\\instance_segmentation\\mmdetection_scoring\\results\\gt_107_2\\'
for i in file_name:
    ...
    show_result(img, result, model.CLASSES,show=None,out_file=save_name)
